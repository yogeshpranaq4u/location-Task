...
import com.example.demoproject.ui.ViewBlogFragment
...
val fragmentList: ArrayList<Fragment> = arrayListOf(HomeFragment(), BusinessNewsFragment(), ViewBlogFragment())
val fragmentTitleList: ArrayList<String> = arrayListOf("All", "Business", "Blog")